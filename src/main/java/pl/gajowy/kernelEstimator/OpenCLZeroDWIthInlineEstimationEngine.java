...
public class OpenCLZeroDWIthInlineEstimationEngine implements EstimationEngine {
    ...
    public CalculationOutcome estimate(float bandwidth, float[] dataPoints, SamplingSettings samplingSettings) {
        ...
        try {
            ...
            //TODO program path
            CLProgram program = context.createProgram(new ClassPathResource("/pl/gajowy/kernelEstimator/kernels/ZeroDWithInline.cl").getInputStream()).build();
